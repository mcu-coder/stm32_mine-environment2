...
* @{
*/
#define REPORT_TIME_MAX 3000 //6S
/**@} */    
...
#define pm25_MAX                           500
#define pm25_LEN                           2
#define smoge_RATIO                         1
#define smoge_ADDITION                      0
#define smoge_MIN                           0
#define smoge_MAX                           1000
#define smoge_LEN                           2
...
typedef enum
{
    control_mode_VALUE0 = 0,//自动模式
    control_mode_VALUE1 = 1,//手动模式
    control_mode_VALUE_MAX,
} control_mode_ENUM_T;
